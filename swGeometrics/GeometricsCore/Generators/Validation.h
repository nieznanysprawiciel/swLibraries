...
//ReturnResult			CompileTimeValidation		( const Processor& processor, const Processors&... processors );
//
//// ================================ //
////
//template< typename VertexType, typename IndexType, typename Generator, typename... Processors >
//ReturnResult			CompileTimeValidation		( const Generator& gen, const Processors&... processors );
//
//
//// ================================ //
////
...
////
//template< typename VertexType, typename IndexType, typename Processor, typename... Processors >
//void					CompileTimeValidation				( const Processor& processor, const Processors& ...processors )
//{
...
////
//template< typename VertexType, typename IndexType, typename Generator, typename... Processors >
//void					CompileTimeValidation				( const Generator& gen, const Processors&... processors )
//{
