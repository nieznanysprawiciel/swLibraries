...
{
	auto gradientStopsAlign = Padding16( sizeof( GradientStop ) );
...
{
    Size restFromConsts = Padding16( constsSize );
    if( restFromConsts == 0)
    {
