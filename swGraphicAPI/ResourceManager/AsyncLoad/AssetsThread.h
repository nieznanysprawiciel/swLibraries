...
AssetsThread calls delegate (@ref LoadingSuccessHandler) specified by requestor to return loaded value.

LoadingSuccessHandler gets @ref AssetLoadResponse in parameter which contains desired resource, path to file and
