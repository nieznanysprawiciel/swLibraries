...
TEST_CASE( "GraphicAPI.TestUtils.MockCompositeAsset.Hierarchy", "[GraphicAPI]" )
{
	...
	CHECK( subassets1[ 0 ]->GetAssetPath().GetFile() == "$(TestAssets)/mock/example.mock");
	...
	CHECK( composites1[ 0 ]->GetSubAssets()[ 0 ]->GetAssetPath().GetFile() == "$(TestAssets)/mock/example3.mock" );
	CHECK( composites1[ 0 ]->GetSubAssets()[ 0 ]->GetContent() == "example3" );

	REQUIRE( composites1[ 1 ]->GetSubAssets().size() == 1 );
	CHECK( composites1[ 1 ]->GetSubAssets()[ 0 ]->GetAssetPath().GetFile() == "$(TestAssets)/mock/example3.mock" );
